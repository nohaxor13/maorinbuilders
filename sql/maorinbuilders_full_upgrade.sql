...
CREATE TABLE IF NOT EXISTS mb_plan_files (id INT AUTO_INCREMENT PRIMARY KEY, project_id INT NULL, title VARCHAR(180) NOT NULL, plan_type VARCHAR(80) NOT NULL DEFAULT 'floor_plan', revision VARCHAR(40) NULL, status VARCHAR(32) NOT NULL DEFAULT 'draft', file_path VARCHAR(255) NULL, file_name VARCHAR(180) NULL, file_type VARCHAR(20) NULL, drawing_scale VARCHAR(20) NOT NULL DEFAULT '1:100', legend_json LONGTEXT NULL, measurements_json LONGTEXT NULL, materials_json LONGTEXT NULL, computed_area DECIMAL(14,3) NOT NULL DEFAULT 0, computed_quantity DECIMAL(14,3) NOT NULL DEFAULT 0, computed_material_cost DECIMAL(14,2) NOT NULL DEFAULT 0, notes TEXT NULL, created_by INT NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, INDEX idx_mb_plan_files_project (project_id)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
