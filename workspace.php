        ...
        <ul class="nav nav-pills workspace-tabs" id="workspaceTabs" role="tablist">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu shadow-sm">
              ...
              <?php if (current_user_can($pdo, 'view_hr')): ?><li><button class="dropdown-item" type="button" data-module="employees">Employees</button></li><li><button class="dropdown-item" type="button" data-module="attendance">Attendance</button></li><?php endif; ?>
