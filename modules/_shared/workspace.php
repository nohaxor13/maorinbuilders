...
function mb_workspace_nav(PDO $pdo): array {
    return [
        ['label'=>'Dashboard','href'=>mb_base_url('account_dashboard.php'),'icon'=>'⌂','permission'=>'view_account_dashboard','feature'=>'account_dashboard'],
        ['section'=>'Operations'],
        ['label'=>'Projects','href'=>mb_base_url('modules/projects/index.php'),'icon'=>'▦','permission'=>'view_projects','feature'=>'projects'],
        ['label'=>'Estimates','href'=>mb_base_url('modules/estimates/index.php'),'icon'=>'◇','permission'=>'view_estimates','feature'=>'estimates'],
        ['label'=>'Proposals','href'=>mb_base_url('modules/proposals/index.php'),'icon'=>'▣','permission'=>'view_proposals','feature'=>'proposals'],
        ['label'=>'Plans','href'=>mb_base_url('workspace.php#plans'),'icon'=>'⌗','permission'=>'view_plans','feature'=>'plans'],
        ['section'=>'Finance'],
        ['label'=>'Purchase Journal','href'=>mb_base_url('purchase_list.php'),'icon'=>'₱','permission'=>'view_journal'],
        ['label'=>'Expenses','href'=>mb_base_url('modules/finance/index.php'),'icon'=>'◉','permission'=>'view_finance','feature'=>'finance'],
        ['label'=>'Invoices','href'=>mb_base_url('modules/finance/invoices.php'),'icon'=>'▤','permission'=>'view_finance','feature'=>'finance'],
        ['section'=>'People & Assets'],
        ['label'=>'Employees','href'=>mb_base_url('modules/hr/index.php'),'icon'=>'☷','permission'=>'view_hr','feature'=>'hr'],
        ['label'=>'Attendance','href'=>mb_base_url('modules/hr/attendance.php'),'icon'=>'◷','permission'=>'manage_attendance','feature'=>'hr'],
        ['label'=>'Inventory','href'=>mb_base_url('modules/inventory/index.php'),'icon'=>'▥','permission'=>'view_inventory','feature'=>'inventory'],
        ['label'=>'Documents','href'=>mb_base_url('modules/documents/index.php'),'icon'=>'□','permission'=>'view_documents','feature'=>'documents'],
        ['label'=>'Reports','href'=>mb_base_url('modules/reports/index.php'),'icon'=>'↗','permission'=>'view_reports','feature'=>'reports'],
        ['section'=>'System'],
