...
function ws_hr_bootstrap(PDO $pdo): void {
  ...
  foreach (['late_minutes'=>"INT NOT NULL DEFAULT 0", 'overtime_hours'=>"DECIMAL(6,2) NOT NULL DEFAULT 0", 'payable_day'=>"DECIMAL(5,2) NOT NULL DEFAULT 1"] as $c=>$d) ws_add_col($pdo,'mb_attendance',$c,$d);
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="mb-form-grid single">
          ...
          <label>Time In<input class="form-control" type="time" data-att-modal-field="time_in"></label>
